...
-- Crear Function para Trigger
CREATE OR REPLACE FUNCTION fn_log_shoelace() RETURNS TRIGGER AS $shoelace_data$
    BEGIN
    ...
    END;
$shoelace_data$ LANGUAGE plpgsql;

-- Crear Trigger
CREATE TRIGGER tr_log_shoelace
AFTER UPDATE ON shoelace_data
    FOR EACH ROW EXECUTE PROCEDURE fn_log_shoelace();
